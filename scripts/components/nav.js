  ...
  render() {
    ...
    <nav class="nav">
      <div class="nav-brand-section">
        <img class="nav-icon" src="./images/logo.png" alt="Det Norske Nye Storband Logo">
        <a class="nav-item" href="./index.html">Det Nye Norske Storband</a>
      ...
      <div class="nav-section nav-section-content-desktop">
        <a class="nav-item" href="./members.html">Medlemmer</a>
        <a class="nav-item" href="./projects.html">Prosjekter</a>
        <a class="nav-item" href="./about.html">Om Oss</a>
        <a class="nav-item" href="./contact.html">Kontakt Oss</a>
      </div>
